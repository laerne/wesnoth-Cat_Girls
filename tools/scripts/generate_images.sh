...
python -m sprite_manager kra -i :/images-kra/exports -o :/images --recursive --update-only


python -m sprite_manager recolor -i :/images/units -o :/images-recolored/units                                         \
    --color-suffixes --color-folders --recursive --strong-update-only                                                  \
    --from magenta,cyan                                                                                                \
    --to red,indianyellow                                                                                              \
...
python -m sprite_manager animate -i :/json-animations --recursive --update-only
