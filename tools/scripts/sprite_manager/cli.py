...
def parse_args(argv):
    ...
    def add_input_output_args(parser, output_option=True):
    ...
    add_input_output_args(animate_parser, output_option=False)
    add_update_only_arg(animate_parser)
    animate_parser.add_argument('--wml', action='store_true', default=False,
            help='Export the WML animation snippets. If neither --wml nor --gif are provided, both --wml and --gif are implied.')
    animate_parser.add_argument('--gif', action='store_true', default=False,
            help='Export the gif animation files. If neither --wml nor --gif are provided, both --wml and --gif are implied.')
